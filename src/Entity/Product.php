...
class Product
{
    ...
    {
        return 'uploads/Illustration/photos/' .$this->illustration;
    }
    ...
    public function isIsBests(): ?bool
    {
        return $this->isBests;
    }

    public function setIsBests(bool $isBests): self
    {
