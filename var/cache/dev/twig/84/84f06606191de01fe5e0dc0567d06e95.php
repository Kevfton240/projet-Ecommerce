...
class __TwigTemplate_db11779d7adb7ec87ffcd28708e90587 extends Template
{
    private $source;
    private $macros = [];
    ...
    C'est dans cette espace que vous allez pouvoir gérer vos informations personnelles.
    <hr>
    -<a href=\"";
        // line 11
    ...
    -<a href=\"";
        // line 12
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_adress");
...
<h1>Mon compte</h1>
    ...
    -<a href=\"{{ path('app_adress') }}\">Gerer mes adresses</a><br>
    -Ajouter mes adresses <br/>
    -Mes commandes <br/>
    <hr>
...
{% endblock %}
", "account/index.html.twig", "/Users/kevin/PhpstormProjects/La boutique/E-shop/templates/account/index.html.twig");
    }
}
