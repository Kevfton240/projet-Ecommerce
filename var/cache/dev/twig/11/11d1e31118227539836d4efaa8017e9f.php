...
class __TwigTemplate_4e88787fef3758600a16f5ba1d106aae extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"product-item text-center\">
        <a href=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_product", ["slug" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 3, $this->source); })()), "name", [], "any", false, false, false, 3)]), "html", null, true);
        echo "\"><img src=\"uploads/Illustration/photos/";
        ...
        // line 6
        echo twig_escape_filter($this->env, (twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 6, $this->source); })()), "price", [], "any", false, false, false, 6) / 100), "html", null, true);
        echo "€</span>
    </div>
";
    ...
    public function getSourceContext()
    {
        return new Source("
    <div class=\"product-item text-center\">
        <a href=\"{{ path('app_product', {'slug': product.name}) }}\"><img src=\"uploads/Illustration/photos/{{ product.illustration  }}\" alt=\"{{ product.name }}\" class=\"img-fluid\"></a>
        <h5>{{ product.name }}</h5>
        <span class=\"product-subtitle\">{{ product.subtitle }}</span>
        <span class=\"product-price\">{{ product.price /100}}€</span>
    </div>
", "product/single_product.html.twig", "/Users/kevin/PhpstormProjects/La boutique/E-shop/templates/product/single_product.html.twig");
    }
}
