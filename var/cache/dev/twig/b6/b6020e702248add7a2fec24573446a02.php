...
class __TwigTemplate_48412d5bcc6b2cb1a9277ab80ca89242 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
       ...
       <span class=\"product-page-price\"> ";
        // line 15
        echo twig_escape_filter($this->env, (twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 15, $this->source); })()), "price", [], "any", false, false, false, 15) / 100), "html", null, true);
        echo " €</span>
        <hr>
        <p>
            ";
        ...
        echo "
            ...
            <a href=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_carte", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 20, $this->source); })()), "id", [], "any", false, false, false, 20)]), "html", null, true);
...
";
    ...
    {
        return array (  122 => 20,  117 => 18,  111 => 15,  106 => 13,  102 => 12,  94 => 9,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    ...
    <div class=\"row\">
        <div class=\"col-md-4\">
         <img src=\"/uploads/Illustration/photos/{{ product.illustration  }}\" alt=\"{{ product.name }}\" class=\"img-fluid\">
        </div>
        <div class=\"col-md-8\">
        <h3>{{ product.name }}</h3>
        <p>{{ product.subtitle }}</p>
        <hr>
       <span class=\"product-page-price\"> {{  product.price /100}} €</span>
        <hr>
        <p>
            {{ product.description }}
        </p>
            <a href=\"{{ path('app_carte' , {'id': product.id}) }}\" class=\"btn btn-primary\">Ajouter au panier</a>
            <br>
            <br>
            <br>
            <br>
...
", "product/show.html.twig", "/Users/kevin/PhpstormProjects/La boutique/E-shop/templates/product/show.html.twig");
    }
}
